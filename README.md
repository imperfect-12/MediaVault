...
MediaVault is a MERN personal media tracker for anime, manga and games. It uses JWT auth in httpOnly cookies, MongoDB via Mongoose, and Cloudinary poster uploads from the React client.
